...
export const translations = {
  en: {
    landing: {
      ...
      hero: {
        badge: "Online loans across Central & West Africa",
        titleLine1: "Fast loans for every",
        titleLine2: "real financial need",
        subtitle: "Apply online in minutes. Funds arrive on your mobile money wallet — no collateral, no branch visit, six loan products for life's real demands.",
        cta1: "Apply for a loan",
        cta2: "See loan products",
        stats: [
          { value: "6", label: "Loan products", desc: "tailored to your life" },
      ...
      products: {
        title: "Six loan products for real everyday needs",
        subtitle: "Each product is purpose-built, with amounts, rates, and terms designed around how people actually live and work.",
      ...
      repayment: {
        ...
        methods: [
          { title: "MTN Mobile Money", body: "Send your monthly payment directly from your MTN MoMo wallet — available 24/7 where supported." },
      ...
      why: {
        ...
        subtitle: "Built for the financial reality of Central & West Africa, not a generic template.",
        reasons: [
          ...
          { title: "Loans built around real life", body: "From agriculture harvest cycles to school registration deadlines and moto-taxi financing — our loan products reflect the actual financial rhythms of people across the region." },
        ],
      },
      faq: {
        ...
        items: [
          { q: "How quickly can I receive a loan?", a: "Once your ID is verified and your application is approved, disbursement to your Mobile Money wallet (MTN MoMo or Orange Money) or bank account typically happens within the same business day." },
          ...
          { q: "What is ID verification and why is it required?", a: "ID verification is a one-time identity check required by financial regulations. You submit your national ID or passport once; after approval you can apply for any loan product." },
        ],
      },
      cta: {
      ...
      footer: {
        tagline: "Central & West Africa's online micro-lending platform. Fast, fair, collateral-free.",
        ...
        copyright: (y: number) => `© ${y} BorrowMe2K. All rights reserved. Serving borrowers across Central & West Africa.`,
        currency: "Amounts in CFA Franc (XAF / XOF / FCFA) or local currency",
      },
    },
    ...
    auth: {
      tabLogin: "Login",
      tabSignup: "Sign Up",
      tagline: "Your instant loan partner across Central & West Africa — borrow, build, repay.",
      login: {
      ...
      register: {
        ...
        cityLabel: "City",
        cityPlaceholder: "e.g. Lagos, Dakar, Abidjan…",
    ...
    kyc: {
      ...
      subtitle: "Before you can access BorrowMe2K, we need to verify your identity. This is a one-time process required by financial regulations.",
  ...
  fr: {
    landing: {
      ...
      hero: {
        badge: "Prêts en ligne en Afrique Centrale & de l'Ouest",
        titleLine1: "Des prêts rapides pour",
        titleLine2: "chaque besoin financier réel",
        subtitle: "Faites votre demande en ligne en quelques minutes. Les fonds arrivent sur votre portefeuille mobile money — sans garantie, sans visite en agence, six produits pour vos besoins réels.",
        cta1: "Demander un prêt",
        cta2: "Voir les produits",
        stats: [
          { value: "6", label: "Produits de prêt", desc: "adaptés à votre vie" },
      ...
      products: {
        title: "Six produits de prêt pour de vrais besoins du quotidien",
        subtitle: "Chaque produit est conçu avec des montants, des taux et des durées adaptés à la façon dont les gens vivent et travaillent.",
        amountRange: "Montant",
      ...
      repayment: {
        ...
        methods: [
          { title: "MTN Mobile Money", body: "Envoyez votre mensualité directement depuis votre portefeuille MTN MoMo — disponible 24h/24, 7j/7 là où le service est disponible." },
      ...
      why: {
        ...
        subtitle: "Construit pour la réalité financière de l'Afrique Centrale & de l'Ouest, pas un modèle générique.",
        reasons: [
          ...
          { title: "Prêts conçus pour la vraie vie", body: "Des cycles de récolte agricole aux délais d'inscription scolaire et au financement de moto-taxi — nos produits reflètent les rythmes financiers réels des gens à travers la région." },
        ],
      },
      faq: {
        ...
        items: [
          { q: "Comment recevoir rapidement un prêt ?", a: "Une fois votre identité vérifiée et votre demande approuvée, le versement sur votre portefeuille Mobile Money (MTN MoMo ou Orange Money) ou compte bancaire se fait généralement dans la même journée ouvrable." },
          ...
          { q: "Qu'est-ce que la vérification d'identité et pourquoi est-elle requise ?", a: "La vérification d'identité est un contrôle unique requis par la réglementation financière. Vous soumettez votre carte nationale d'identité ou passeport une fois ; après approbation, vous pouvez demander n'importe quel produit." },
        ],
      },
      cta: {
      ...
      footer: {
        tagline: "Plateforme de micro-prêt en ligne d'Afrique Centrale & de l'Ouest. Rapide, équitable, sans garantie.",
        ...
        copyright: (y: number) => `© ${y} BorrowMe2K. Tous droits réservés. Au service des emprunteurs à travers l'Afrique Centrale & de l'Ouest.`,
        currency: "Montants en Franc CFA (XAF / XOF / FCFA) ou monnaie locale",
      },
    },
    ...
    auth: {
      ...
      tagline: "Votre partenaire de prêt instantané en Afrique Centrale & de l'Ouest — empruntez, construisez, remboursez.",
      login: {
      ...
      register: {
        ...
        cityLabel: "Ville",
        cityPlaceholder: "ex. Dakar, Lagos, Abidjan…",
    ...
    kyc: {
      ...
      subtitle: "Avant d'accéder à BorrowMe2K, nous devons vérifier votre identité. C'est un processus unique requis par la réglementation financière.",
